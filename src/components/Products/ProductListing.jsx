...
// import { MagnifyingGlassIcon, FunnelIcon, ArrowLeftIcon, XMarkIcon, ChevronUpDownIcon } from '@heroicons/react/24/outline';
...
//         // Ensure each product has createdAt (should be set by MongoDB)
...
//     // Update URL params with filters + sort
//     const urlParams = {};
...
//   const clearFilters = () => setFilters({ gender: '', shoeType: '', search: '', sale: false, minPrice: '', maxPrice: '' });
...
//           <h1 className="text-3xl md:text-4xl font-bold italic text-gray-900 tracking-tight">Our Collection</h1>
//           <p className="text-gray-500 text-sm mt-1">Discover the latest styles</p>
//         </div>
...
//               className="w-full pl-12 pr-10 py-2.5 bg-white border border-gray-200 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-black/20 focus:border-black/30 transition-all duration-200"
//             />
//             {filters.search && (
//               <button
...
//                         className="w-3.5 h-3.5 text-black focus:ring-black/20"
//                       />
//                       <span className="text-sm text-gray-700 group-hover:text-black transition">{g}</span>
//                     </label>
//                   ))}
//                 </div>
//               </div>
...
//                       <input
//                         type="checkbox"
//                         checked={filters.shoeType === type}
//                         onChange={() => handleFilterChange('shoeType', filters.shoeType === type ? '' : type)}
//                         className="w-3.5 h-3.5 text-black focus:ring-black/20 rounded"
//                       />
//                       <span className="text-sm text-gray-700 group-hover:text-black transition">{type}</span>
//                     </label>
//                   ))}
//                 </div>
//               </div>
...
//                   className="w-3.5 h-3.5 text-black focus:ring-black/20 rounded"
//                 />
//                 <span className="text-sm text-gray-700 group-hover:text-black transition">On Sale Only</span>
//               </label>
...
//                         {filters.gender} <button onClick={() => handleFilterChange('gender', '')} className="hover:text-red-500">✕</button>
//                       </span>
//                     )}
//                     {filters.shoeType && (
//                       <span className="inline-flex items-center gap-1 bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">
//                         {filters.shoeType} <button onClick={() => handleFilterChange('shoeType', '')} className="hover:text-red-500">✕</button>
//                       </span>
//                     )}
//                     {filters.sale && (
//                       <span className="inline-flex items-center gap-1 bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">
//                         Sale <button onClick={() => handleFilterChange('sale', false)} className="hover:text-red-500">✕</button>
//                       </span>
//                     )}
//                     {(filters.minPrice || filters.maxPrice) && (
//                       <span className="inline-flex items-center gap-1 bg-gray-100 text-gray-800 text-xs px-2 py-1 rounded-full">
//                         ${filters.minPrice || '0'} - ${filters.maxPrice || '∞'}
//                         <button onClick={() => { handleFilterChange('minPrice', ''); handleFilterChange('maxPrice', ''); }} className="hover:text-red-500">✕</button>
//                       </span>
//                     )}
//                   </div>
//                 </div>
...
//                       className="appearance-none bg-white border border-gray-200 rounded-lg pl-3 pr-8 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-black/20 cursor-pointer"
//                     >
